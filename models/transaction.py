...
class Transaction:
    ...
    def append_temporary_transaction(account_number, account_name, txn_id, sub_txn_id, amount):
        ...
        shard_file_name = TEMPORARY_SHARD_NAME_PREFIX+str(shard_id)+'.CSV'
    ...
    def commit_transaction(account_number, transaction_id):
        ...
        dest_shard_file_name = CONFIRMED_SHARD_NAME_PREFIX+str(shard_id)+'.CSV'
    ...
    def read_transaction_from_transaction_pool():
